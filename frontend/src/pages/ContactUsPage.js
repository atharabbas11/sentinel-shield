...
//         <section id="contact" className="my-12 mt-20">
//           <h1 className="text-5xl font-semibold text-center mb-8 text-white">Contact</h1>
//           <div className="container mx-auto flex flex-col md:flex-row items-center">
//             <div className="w-full md:w-2/5 text-center md:text-right p-2">
...
//             <div className="mx-auto md:w-2/3 lg:w-1/2 bg-gray-900 opacity-70">
